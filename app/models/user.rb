class User < ApplicationRecord
  ...
  has_many :sent_pokes, class_name: "Poke", foreign_key: "sender_id", dependent: :destroy
  has_many :received_pokes, class_name: "Poke", foreign_key: "receiver_id", dependent: :destroy
